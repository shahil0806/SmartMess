...
@media(max-width:760px){.side{display:none}.dash-main{margin-left:0}.dash-top{padding:0 15px}.dash-top h1{font-size:18px}.dash-content{padding:15px}.metric-row,.metric-row.small,.student-layout .metric-row,.menu-grid{grid-template-columns:1fr}.welcome{align-items:flex-start;gap:12px}.date-pill{font-size:12px}.mobile-nav{display:block}.profile-box{flex-direction:column}.quick{grid-template-columns:1fr}.login-page{display:block;padding:0;background:#fff}.login-shell{width:100%;min-height:100svh;display:block;border:0;border-radius:0;box-shadow:none}.login-hero{padding:22px 20px 48px;min-height:0}.login-hero:after{width:190px;height:190px;border-width:35px;right:-115px;top:-55px}.login-logo{justify-content:flex-start}.login-logo img{width:56px;height:56px}.login-logo strong{font-size:16px}.login-logo span{font-size:12px}.login-hero-content,.login-building{display:none}.login-pane{position:relative;z-index:2;margin-top:-26px;min-height:calc(100svh - 104px);padding:39px 20px 24px;border-radius:28px 28px 0 0;background:#fff;align-items:flex-start}.login-box{max-width:420px}.login-box h2{font-size:27px}.login-box .sub{margin-bottom:26px}.login-tabs{display:none}.admin-login-box{padding:0;border:0;border-radius:0;box-shadow:none;overflow:visible}.admin-login-box:before{display:none}.role-options{grid-template-columns:repeat(3,1fr);gap:5px}.role-options label{padding:10px 3px;font-size:10px}.remember-help{align-items:center;flex-direction:row;font-size:12px}.mobile-login-features{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-top:25px}.mobile-login-feature{min-height:72px;padding:10px 5px;border:1px solid #dce6f4;border-radius:12px;background:#f9fbff;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:7px;text-align:center;color:#263650;font-size:10px;font-weight:800}.mobile-login-feature svg{width:25px;height:25px;fill:none;stroke:#0769e8;stroke-width:1.9;stroke-linecap:round;stroke-linejoin:round}}
</style>
"""
